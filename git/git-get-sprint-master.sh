...
### OBJETIVO: 
### Atualizar sua branch com a branch master, passando pela branch da sprint
### Ou seja, somente busca as alterações existentes na master para a branch da sprint e sua branch corrente.
###
...
# 06 - Muda para a branch da sprint atual (git checkout "branch-da-sprint")
# 07 - Injeta as atualizações recebidas da master para a branch da sprint (git merge master)
# 08 - Envia para o remote as mudanças aplicadas na branch da sprint (git push origin "branch-da-sprint")
...
echo -e ""
echo -e "${YEL}Get master updates into your branch ${GRE}$__currentBranchName${YEL} and the sprint's branch ${GRE}$__sprintBranchName${YEL}.${RES}"
echo -e ""
...
# 06 - Muda para a branch da sprint atual (git checkout "branch-da-sprint")
echo -e ""
echo -e "${YEL}Goint to sprint branch [${RES}git merge ${GRE}$__sprintBranchName${YEL}]...${RES}"
echo -e ""
git checkout $__sprintBranchName

# 07 - Injeta as atualizações recebidas da master para a branch da sprint (git merge master)
echo -e ""
echo -e "${YEL}Merging master branch into sprint [${RES}git merge ${GRE}master${YEL}]...${RES}"
echo -e ""
git merge master
